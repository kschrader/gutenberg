...
Gutenberg is intended to be an ultra-lightweight bit of blogging software based
on Merb. I'm planning on replacing Typo with to power my blog. It's also a good
example of a simple Merb application to learn from.
